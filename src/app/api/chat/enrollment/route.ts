...
- Block coding, game development, and robotics basics, no prior experience needed
...
The best KAT students go on to become KAT Fellows. Fellows mentor the next generation, lead real-world community-impact projects, and build a reputation that opens doors.
