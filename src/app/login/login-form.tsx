...
/**
 * `googleEnabled` is resolved on the server (see page.tsx) rather than from
 * NEXT_PUBLIC_GOOGLE_OAUTH_ENABLED here, because it also depends on the request
 * HOST: Google's OAuth redirect URI is bound to NEXTAUTH_URL (the apex), so a
 * Google sign-in started on the school host would return to the apex and set the
          ...
          >
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <Button
                ...
                type="submit"
                className="h-11 w-full rounded-xl bg-kat-blue text-sm font-semibold hover:bg-[#A63A1C]"
              >
