    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>Bot-protection signals when you sign in or register, processed by Cloudflare
            Turnstile (see <a href="#third-parties">Third parties</a>)</li>
        </ul>
      </>
    ),
  },
    ...
    body: (
      <>
        <ul>
          ...
          <li><strong>Cloudflare Turnstile</strong>, bot protection on our sign-in and
            registration forms, used to tell real users from automated abuse. Cloudflare
            processes limited technical signals from your browser to run this check. That
            processing is governed by Cloudflare&rsquo;s{" "}
            <a
