...
export function AdminRegisterForm() {
  ...
  const validateInvite = async (nextToken: string) => {
    ...
    setValidating(true);
    const response = await fetch(`/api/super-admin/admin-invites/accept?token=${encodeURIComponent(nextToken)}`);
  ...
  const submit = async (event: FormEvent) => {
    ...
    setLoading(true);
    const response = await fetch("/api/super-admin/admin-invites/accept", {
      method: "POST",
    ...
    toast.success(`${roleLabel} account activated.`);
